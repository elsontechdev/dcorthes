...
import { defumado2, defumadoImage, defumados } from "../../../public/assets/images";
import { Defumados } from "..";
  ...
  return (
    <main>
      ...
      <div className="w-full flex justify-center">
        <Image className="w-[80%]" src={defumadoImage} alt="defumados"></Image>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 my-20">
        ...
        <div className=" overflow-hidden">
          <Image className="w-[70%] m-auto h-[600px] " src={defumado2} width={1000} height={1000} alt='' />
        </div>
